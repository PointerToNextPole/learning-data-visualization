  ...
  <common-card
    ...
    <template v-slot:footer>
      <div class="total-user-footer">
        <span>日同比</span>
        <span class="emphasis">129.59%</span>
        <div class="increase"/>
        <span class="month">月同比</span>
        <span class="emphasis">186.99%</span>
        <div class="decrease"/>
      </div>
    </template>
  </common-card>
...
<svg t="1610123452759" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5479" width="200" height="200">
  <path d="M952.32 715.2l-416-485.376c-12.16-14.176-36.448-14.176-48.608 0l-416 485.376c-8.128 9.472-9.984 22.848-4.768 34.176C72.16 760.704 83.488 768 96 768h832c12.512 0 23.84-7.296 29.056-18.624s3.392-24.704-4.736-34.176z" p-id="5480" style="user-select: auto;"></path></svg>
